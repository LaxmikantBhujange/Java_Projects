	...
	public static void main(String[] args) {
		...
		case "Information_Technology":
			...
			for (i = 0; i < bk.length; i++) {
				System.out.println(
						bk[i].getId() + " " + bk[i].getName() + " " + bk[i].getPrice() + " " + bk[i].getNo_of_copies());
			}
			...
			for (i = 0; i < bk.length; i++) {
				if (bk[i].getName().equalsIgnoreCase(c_book)) {
					flag = 1;
					break;
				}
			}
			...
			if (flag == 1) {
				...
				if (n_book > bk[i].getNo_of_copies()) {
					System.out.println(bk[i].getNo_of_copies() + " Copies are Available Only");
				} else {
		...
		case "Electronics_Engineering":
			...
			for (i = 0; i < bk1.length; i++) {
				if (bk1[i].getName().equalsIgnoreCase(c_book1)) {
					flag = 1;
					break;
				}
			}
			if (flag == 1) {
				...
				if (n_book > bk1[i].getNo_of_copies()) {
					System.out.println(bk1[i].getNo_of_copies() + " Copies are Available Only");
				} else {
					System.out.println("Please Enter Your Name");
					String u_name = in.next();
		...
		case "Mechanical_Engineering":
			...
			for (i = 0; i < bk2.length; i++) {
				System.out.println(bk2[i].getId() + " " + bk2[i].getName() + " " + bk2[i].getPrice() + " "
						+ bk2[i].getNo_of_copies());
			}
			...
			for (i = 0; i < bk2.length; i++) {
				if (bk2[i].getName().equalsIgnoreCase(c_book2)) {
					flag = 1;
					break;
				}
			}
			if (flag == 1) {
				...
				if (n_book > bk2[i].getNo_of_copies()) {
					System.out.println(bk2[i].getNo_of_copies() + " Copies are Available Only");
				} else {
					System.out.println("Please Enter Your Name");
					String u_name = in.next();
		...
		case "Civil_Engineering":
			...
			for (i = 0; i < bk3.length; i++) {
				System.out.println(bk3[i].getId() + " " + bk3[i].getName() + " " + bk3[i].getPrice() + " "
						+ bk3[i].getNo_of_copies());
			}
			...
			for (i = 0; i < bk3.length; i++) {
				if (bk3[i].getName().equalsIgnoreCase(c_book3)) {
					flag = 1;
					break;
				}
			}
			if (flag == 1) {
				...
				if (n_book > bk3[i].getNo_of_copies()) {
					System.out.println(bk3[i].getNo_of_copies() + " Copies are Available Only");
				} else {
					System.out.println("Please Enter Your Name");
					String u_name = in.next();
		...
		case "Stories":
			...
			for (i = 0; i < bk4.length; i++) {
				System.out.println(bk4[i].getId() + " " + bk4[i].getName() + " " + bk4[i].getPrice() + " "
						+ bk4[i].getNo_of_copies());
			}
			...
			for (i = 0; i < bk4.length; i++) {
				if (bk4[i].getName().equalsIgnoreCase(c_book4)) {
					flag = 1;
					break;
				}
			}
			if (flag == 1) {
				...
				if (n_book > bk4[i].getNo_of_copies()) {
					System.out.println(bk4[i].getNo_of_copies() + " Copies are Available Only");
				} else {
					System.out.println("Please Enter Your Name");
					String u_name = in.next();
